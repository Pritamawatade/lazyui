---
title: Installation
description: Getting started with lqdui
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://lazyui.online/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://lazyui.online/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://lazyui.online/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://lazyui.online/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://lazyui.online/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://lazyui.online/r/card-05.json
```
...
```jsx
import Card05 from "@/components/lqdui/card-05";
...
```bash tab="bun"
bunx shadcn@latest add https://lazyui.online/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://lazyui.online/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://lazyui.online/r/ai-card-generation.json
```
 ...
 */
import AICardGeneration from "@/components/lqdui/AICardGeneration";
...
```bash tab="bun"
bunx shadcn@latest add https://lazyui.online/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://lazyui.online/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://lazyui.online/r/card-05.json -c ./apps/www
```
