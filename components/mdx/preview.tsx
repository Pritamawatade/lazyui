    ...
    <>
      <div className={cn("w-full overflow-hidden", className)}>
        ...
        {useIframe ? (
          ...
          <div
            className={cn(
              "p-2 md:p-8 flex justify-center items-center bg-gradient-to-br from-[#dbeafe] to-[#818cf8] relative border rounded-2xl my-4 border-zinc-400 dark:border-zinc-800 not-prose",
