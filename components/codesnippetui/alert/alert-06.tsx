...
export default function Alert06() {
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-white/30 dark:from-purple-950/50 dark:to-zinc-950 border border-purple-100 dark:border-purple-900/50 shadow-[0_1px_3px_0_rgba(147,51,234,0.1),0_1px_2px_-1px_rgba(147,51,234,0.1)] dark:shadow-[0_1px_3px_0_rgba(147,51,234,0.05),0_1px_2px_-1px_rgba(147,51,234,0.05)] p-1">
        <div className="relative z-10 flex items-center gap-4 p-4 bg-white/30 dark:bg-zinc-950/50 rounded-xl">
