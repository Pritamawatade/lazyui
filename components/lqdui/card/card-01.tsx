...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched lqdui UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "lqdui UI Documentation",
            description: "A comprehensive guide to lqdui UI",
